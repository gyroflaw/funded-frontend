...
import { LocalBusiness } from "./pages";
...
function App() {
  ...
  if (categoriesNotInLocalStorage()) {
        ...
        <AnimatePresence exitBeforeEnter>
          ...
          <Routes>
            ...
            <Route
              path="/signin"
              exact
              element={<SignIn updateUser={handleUpdateUser} user={user} />}
            />
            ...
            <Route
              path="/projects-map"
              exact
              element={<MapWithAllProjects />}
            />
            <Route path="/forms" exact element={<Form />} />
            <Route
              path="/my-rewards"
              exact
              element={<Rewards updateUser={handleUpdateUser} user={user} />}
            />
            <Route
              path="/register-a-business"
              exact
              element={<RegisterBusiness2 />}
            />
