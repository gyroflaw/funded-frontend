                            ...
                            {section.options.map((option, optionIdx) => (
                              ...
                              >
                                <input
                                  ...
                                  type="checkbox"
                                  defaultChecked={option.checked}
                                  className="h-4 w-4 border-gray-300 hover:cursor-pointer rounded text-indigo-600 focus:ring-indigo-500"
                                />
                                <label
                                  htmlFor={`filter-${section.id}-${optionIdx}`}
                                  className="ml-3 text-sm hover:cursor-pointer text-gray-600"
                                >
                                  {option.label}
                                </label>
                              </div>
